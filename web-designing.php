...
<head>
    ...
    <meta name="keywords"content="Web Designing course Dharamshala , web design training Dharamshala Himachal Pradesh, Netcoder Technology, learn web design, HTML, CSS, responsive design, graphic design for web, UI design, web development skills, career in web design, Dharamshala  tech education
    ">
    <meta name="description"content="Join the Web Designing course in Dharamshala  at Netcoder Technology. Learn HTML, CSS, and responsive design to create visually appealing and user-friendly websites.">
    <title> Web Designing Course in Dharamshala | Netcoder Technology</title>
     <!-- canonical tag -->
     <link rel="canonical" href="https://www.netcoder.in/web-designing/" />
    <!-- favicon -->
...
<body>
 <header class="main-header">
    ...
    <div class="course-single container">
        ...
        <div>
            <h2><span>Web Designing</span></h2>
            <p>In order to make a website aesthetically pleasing, user-friendly, and responsive to a variety of device sizes, web designers employ a variety of design principles, HTML, and CSS. Good web design also takes user experience (UX) into account to make navigation easy to use and interesting.
            </p>
        ...
        <div class="col">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div>
                        <h4>HTML and CSS</h4>
                        <small>Weeks three through five concentrate on the fundamentals of HTML and CSS, including HTML syntax, structure, and the creation of different elements such as lists, tables, forms, links, and images. After that, students study CSS selectors, syntax, and styling methods like Grid Layout and Flexbox. Semantic HTML, sophisticated CSS properties, and media queries for responsive web design are examples of advanced topics.</small>
                    </div>
                </li>
                <!--  -->
                <li>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <small>Students organize, plan, and carry out a web design project in weeks eleven and twelve, with an emphasis on testing and debugging. They then get ready for job interviews and freelance opportunities by putting together an online portfolio to display their work.</small>
                    </div>
                </li>
                <!--  -->
                <li>
                    <h4>6.</h4>
                    <div>
                        <h4>Advanced Web Design Topics</h4>
                        <small>Advanced topics like CSS animations, JavaScript interactive element creation, and using animation libraries like GSAP are covered in weeks thirteen and fourteen. Additionally, the fundamentals of SEO, creating accessible websites, and utilizing accessibility testing tools are taught to students.</small>
                    </div>
                </li>
                <!--  -->
